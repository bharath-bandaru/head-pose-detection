...
def parse_args():
    ...
    parser.add_argument('--data_dir', dest='data_dir', help='Directory path for data.',
          default='/Users/BharathBandaru/Desktop/code/CV/data/300W_LP/LFPW', type=str)
    parser.add_argument('--filename_list', dest='filename_list', help='Path to text file containing relative paths for every example.',
          default='/Users/BharathBandaru/Desktop/code/CV/head-pose-detection/project ref/deep-head-pose-master/file_lists.txt', type=str)
